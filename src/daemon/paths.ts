 ...
 */
export const SERVICE_NAME = 'lark-ksgc-bridge.bot';
 ...
 * `LarkKsgcBridge\Bot` would create a Bot task under a LarkKsgcBridge
 * folder. We keep it flat for now.
 */
export const WINDOWS_TASK_NAME = 'LarkKsgcBridge.Bot';
